...
import { FiCheck, FiChevronRight, FiCode, FiLayers, FiLock, FiUsers, FiZap } from 'react-icons/fi';
...
const features = [
  {
    ...
    description: 'Create rich documents with our intuitive block-based editor. Each piece of content is a block that you can easily move and style.'
  },
  {
  ...
  },
  {
    ...
    title: 'Code Blocks',
    description: 'Write and format code with syntax highlighting. Perfect for developers and technical writers.'
  },
  {
    icon: <FiLock className="w-6 h-6 text-amber-600" />,
    title: 'End-to-End Encryption',
    description: 'Your data is secure with our enterprise-grade encryption. We prioritize your privacy and security.'
  }
];
...
const faqs = [
  {
    ...
    answer: 'Yes, we offer a free plan with basic features. You can upgrade anytime.'
  },
  {
    question: 'How secure is my data?',
    answer: 'We use end-to-end encryption and follow industry best practices to keep your data safe.'
  },
  {
    question: 'Can I use it offline?',
    answer: 'Yes, you can create and edit documents offline. Changes will sync when you\'re back online.'
  },
  {
    question: 'How do I invite team members?',
    answer: 'Go to your workspace settings and click on "Invite Members" to add people via email.'
  }
];
...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                <span className="text-2xl font-bold text-gray-900">Notion Clone</span>
              </div>
            </div>
            <div className="hidden sm:ml-6 sm:flex sm:items-center space-x-8">
              ...
              <Link 
                ...
                style={{ backgroundColor: colors.primary, ':hover': { backgroundColor: '#4a6b25' } }}
              >
                Get Started
              </Link>
            </div>
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-green-600">workspace for your team</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Write, plan, and get organized. Notion Clone is the connected workspace where better, faster work happens.
          </p>
      ...
      <div className="bg-green-700">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg leading-6 text-green-200">
            Join thousands of teams who are already using Notion Clone to be more productive.
          </p>
          <Link 
            to="/register" 
      ...
      {/* Footer */}
      <footer style={{ backgroundColor: colors.card, borderTop: `1px solid ${colors.border}` }}>
        <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
            ...
            {['About', 'Blog', 'Jobs', 'Press', 'Accessibility', 'Partners'].map((item) => (
              <div key={item} className="px-5 py-2">
                <a 
                  ...
                  style={{ color: colors.textMuted, ':hover': { color: colors.textPrimary } }}
                >
                  {item}
                </a>
              </div>
          ...
          <p className="mt-8 text-center text-base" style={{ color: colors.textMuted, opacity: 0.7 }}>
